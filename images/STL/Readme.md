...
* [MyBox.stl](./MyBox.stl "フタ付きの箱")
  * 非常にシンプルなフタ付きの箱です。[MyBoxWall.stl](./MyBoxWall.stl)と組み合わせて使用します。
* [MyBoxWall.stl](./MyBoxWall.stl "フタ付きの箱の前板")
  * [MyBox.stl](./MyBox.stl)と組み合わせて使用する板です。
* [MyBoxBig.stl](./MyBoxBig.stl "フタ付きの箱(大)")
