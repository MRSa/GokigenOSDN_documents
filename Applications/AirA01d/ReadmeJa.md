...
画面にあるボタンは、押すと、カメラに設定可能な選択肢を問い合わせ、その選択肢を表示します。
その中から選択肢を選ぶと、カメラにそのコマンドが送られる仕組みとなっています。

撮影モードにより選択肢が限定される場合、あるいは選択肢がない場合にはボタンが反応しないこともありますので、ご了承下さい。
