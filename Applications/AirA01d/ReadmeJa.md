...
- [OLYMPUS AIR AIR A01(プレスリリース)](https://www.olympus.co.jp/jp/news/2015a/nr150205opcj.html)
  - [主な仕様(プレスリリース)](https://www.olympus.co.jp/jp/news/2015a/nr150205opcspj.html)
...
カメラ側の設定を変更する画面（「カメラ設定」画面）を開く予定のボタンです。現状、「カメラ設定」画面は未作成のため、本ボタンは使用できません。
...
![アスペクト比](images/aspect_ratio.png)
